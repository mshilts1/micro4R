...
If you don't know what an ASV (Amplicon Sequence Variant) is, please read [here](https://benjjneb.github.io/dada2/index.html) first.    
...
Let's look at the 'SampleID' field, which are what they sound like, and uniquely identifies each sample:
...
That's why there's also a 'LabID', which is an ID that could have been used all through specimen processing, and is much more human-friendly. 
