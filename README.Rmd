...
The first thing we'll do on these files is run 'dada2_wrapper'. This wrapper can take a number of arguments, but the most important one is 'where', which is the path to where your FASTQ files are located. For demonstration purposes, it's been set to the path of the the example FASTQ files included with the package. 
